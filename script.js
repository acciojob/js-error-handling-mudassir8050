function evaluateExpression(expression) {
  ...
  // Add your logic here to check for invalid combinations

  // Evaluate the expression
  // Add your logic here to evaluate the expression
}
...
try {
  ...
  // Continue with normal execution if the expression is valid
} catch (error) {
  if (error instanceof OutOfRangeError) {
    console.log(error.message);
    // Handle the OutOfRangeError
  } else if (error instanceof InvalidExprError) {
    console.log(error.message);
    // Handle the InvalidExprError
  }
}
